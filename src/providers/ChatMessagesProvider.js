...
const MessagingProvider = ({ children }) => {
  const member = {
    userId: "us-east-1:0e2b096c-488b-409e-ace9-e3676a83ab1e",
    username: "Mark",
  };
  ...
  useEffect(() => {
    ...
    console.log("message service effect called");
  ...
  useEffect(() => {
    // if (!JSON.parse(localStorage.getItem("userId"))) return;
    console.log("this is ChatMessae pro");
